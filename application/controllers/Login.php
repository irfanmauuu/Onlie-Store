...
class Login extends CI_Controller {
	/*public function index tambah berfungsi untuk membuat data array untuk menyimpan nilai ketika user meng-input biodata diri seperti
	 username, email, password dan group. Setelah itu menambahkan data yang di-input kedalam table users.*/
